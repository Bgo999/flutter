...
class _AccessoriesPageState extends State<AccessoriesPage> {
  ...
  List<DepartmentCardData> departmentCards = [
    DepartmentCardData(
        departmentName: 'Տղամարդու',
        imageUrls: [
          'assets/Կոշիկներ/3.jpg',
          'assets/Կոշիկներ/2.png',
          'assets/Կոշիկներ/4.png',
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'Տղամարդու',
        imageUrls: [
          'assets/Կոշիկներ/5.jpg',
          'assets/Կոշիկներ/8.jpg',
          'assets/Կոշիկներ/7.jpg',
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'Կանացի',
        imageUrls: [
          'assets/Կոշիկներ/1.png',
          'assets/Կոշիկներ/10.jpg',
          'assets/Կոշիկներ/11.jpg',
          'assets/Կոշիկներ/16.jpg',
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'Կանացի',
        imageUrls: [
          'assets/Կոշիկներ/12.jpg',
          'assets/Կոշիկներ/13.jpg',
          'assets/Կոշիկներ/14.jpeg',
          'assets/Կոշիկներ/15.jpg',
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'Մանկական',
        imageUrls: [
          'assets/Կոշիկներ/17.jpg',
          'assets/Կոշիկներ/18.jpg',
          'assets/Կոշիկներ/19.jpg',
          'assets/Կոշիկներ/20.jpg',
          'assets/Կոշիկներ/20.jpg',
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'Մանկական',
        imageUrls: [
          'assets/Կոշիկներ/21.jpg',
          'assets/Կոշիկներ/22.jpg',
          'assets/Կոշիկներ/23.jpg',
          'assets/Կոշիկներ/24.jpg',
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Align(
                          ...
                          child: Center(
                            child: Text(
                              'Կոշիկներ', // Updated text for Accessories
                              style: TextStyle(
                                fontSize: 18,
