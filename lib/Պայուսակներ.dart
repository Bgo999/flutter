...
class _ShoesPageState extends State<ShoesPage> {
  ...
  List<DepartmentCardData> departmentCards = [
    ...
    DepartmentCardData(
        departmentName: 'ճանփորդական',
        imageUrls: [
          'assets/Պայուսակներ/1.png',
          'assets/Պայուսակներ/2.png',
          'assets/Պայուսակներ/4.png',
          'assets/Պայուսակներ/8.png',
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'Կաշվե',
        imageUrls: [
          'assets/Պայուսակներ/1.png',
          'assets/Պայուսակներ/2.png',
          'assets/Պայուսակներ/3.png',
          'assets/Պայուսակներ/4.png',
          // Add additional image URLs here
        ],
        price: 100,
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    DepartmentCardData(
        departmentName: 'ճանփորդական',
        imageUrls: [
          'assets/Պայուսակներ/5.png',
          'assets/Պայուսակներ/6.png',
          'assets/Պայուսակներ/7.png',
          'assets/Պայուսակներ/8.png',
          // Add additional image URLs here
        ],
        price: 100,
...
Պատշգամբ Բաց պատշգամբ""" // Add description for the card
    ...
    // Add more department card data here
  ];
